CREATE TABLE TBL_PRODUCT_02 (
    ...
    NAME VARCHAR2(20),
    COST NUMBER(10),
    CONSTRAINT PK_PRODUCT2 PRIMARY KEY (PCODE)
);

CREATE TABLE TBL_SHOP_02 (
    SCODE VARCHAR2(10) NOT NULL,
    SNAME VARCHAR2(20),
    CONSTRAINT PK_SHOP2 PRIMARY KEY (SCODE)
);
...
CREATE TABLE TBL_SALELIST_02 (
    ...
    SCODE VARCHAR2(10) NOT NULL,
    AMOUNT NUMBER(10),
    CONSTRAINT PK_SALELIST2 PRIMARY KEY (SALENO)
);
...
INSERT INTO TBL_SALELIST_02 VALUES(100010, 'A005', '20180902' ,'S003', 30);
